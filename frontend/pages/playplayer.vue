<template>
    <div class="flex justify-center w-screen mt-[155px] text-white">
       ...
       <div class="mt-[50px] text-2xl">
        <Deployment />
          <Chessboard :board="move_request.board" :key="boardKey" @position-clicked="handlePositionClicked" class="mx-auto w-full"/>
        <Decks />
       </div>
       <div>
          ...
          <div class="game-info-container">
             ...
             <div style="position: relative; display: inline-block; width: 64px; height: 64px;">
                ...
                <span style="position: absolute; font-size: 1.5rem; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 2; color: black;">2</span>
             </div>
          </div>
       </div>
    </div>
